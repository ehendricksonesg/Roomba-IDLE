...
# this is the port you're connecting to the irobot with on windows, this is something like COM2
N = 2 
def ints2str(lst):
    '''
...
# define some note lengths change the top MEASURE (4/4 time) to get faster/slower speeds
MEASURE = 160 
HALF = MEASURE/2 
Q = MEASURE/4 
E = MEASURE/8 
...
# play 2 again play 3 again
s.write(ints2str([140, 5, 9,
                  r,E, f4,E, aes4,Q, f4,Ed, c5,S,
                  a4,Q, f4,Ed, c5,S, a4,HALF]))
# once all the songs are uploaded, play them at the right times add a little extra time, b/c otherwise 
# cuts off the end
print("play songs...") 
